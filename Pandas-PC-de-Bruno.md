...
- manipule efficacement les ![données manquantes](#donnees_manquantes)
...
| -------------- | -------------------------------------- |
| `sep = ,`      | <font color='orange'>par défaut</font> |
...
Les index des lignes (axe 0) et les noms de colonnes (axe 1) permettent d'accèder aux données
